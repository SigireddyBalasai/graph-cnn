...
def aux_layer(x, num_classes):
    ...
    """
    global_avg_pool = keras.layers.GlobalAveragePooling2D()(x)
    flat = keras.layers.Flatten()(global_avg_pool)
    fc = keras.layers.Dense(units=num_classes, activation="softmax")(flat)
    return fc
...
def load_layer(layer):
    ...
    Returns:
        keras.layers.Layer: The loaded layer.
